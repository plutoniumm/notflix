...
var (
	activeProcs sync.Map // map[string]*exec.Cmd
	jobs        sync.Map // map[string]*WhisperJob
)
...
func SubsWhisperStream(c *gin.Context, roots []string) {
	...
	// Kill any existing transcription for this file
	...
	// Build VTT from (possibly translated) segments
	var sb bytes.Buffer
