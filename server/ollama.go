...
// TranslateSegments translates subtitle texts from srcLang to English using Ollama.
// Batches in groups of 50. On any batch failure, falls back to original texts.
